...
const Cart = () => {
  ...
  return <Wrapper>
         ...
         <div className="cart-two-button">
          <NavLink to='/products'>
              <Button > Continue Shopping</Button> </NavLink>
          ...
          <div className="order-total--amount">
            <div className="order-total--subdata">
              <div>
                <p> Total : </p><p>             {<CurrencyFormat price={total_amount}   />}</p></div>
                <div><p> Shipping :  </p><p> {<CurrencyFormat price={shipping} />}</p></div>
                <hr />
                <div><p> Order Total  : </p><p>   {<CurrencyFormat price={total_amount + shipping} />}</p>
                </div>
            </div>
          </div>
  </Wrapper>;
