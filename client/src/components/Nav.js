    ...
    <Navs>
        <div className={MenuIcon ? 'navbar active': 'navbar'}>
            <ul className='navbar-lists'>
                ...
                <li>
                    <NavLink to ='/about' className="navbar-link h"  onClick={()=> setMenuIcon(false)}> About </NavLink>
                </li>
                <li>
                ...
                {isAuthenticated ?
               <li>
               <Button onClick={()=>logout({returnTo : window.location.origin})}> Log Out {user.name?.split(' ')[0]}</Button>  </li> : <li>
